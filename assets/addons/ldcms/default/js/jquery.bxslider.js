...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var appendControls = function(){
			slider.controls.next = $('<i class="fa fa-angle-right bx-next" href="">' + slider.settings.nextText + '</i>');
			slider.controls.prev = $('<i class="fa fa-angle-left bx-prev" href="">' + slider.settings.prevText + '</i>');
